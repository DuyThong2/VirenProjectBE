...
{
    Task<ResponseData<Guid>> CreateOrderAsync(CreateOrderRequestDto request, CancellationToken cancellationToken);
    ...
    //Task<ServiceResponse> UpdateOrderStatusAsync(Guid id, CancellationToken ct);
